...
prod_file = "kobe_dataset/data/processed/prediction_prod.parquet" ## AQUI OS DADOS AINDA NAO FORAM SALVOS NA PASTA PORQUE O APPLICATION.PY NAO RODOU
dev_file = "kobe_dataset/data/processed/base_test.parquet"
...
df_dev = pd.read_parque(dev_file)


#saída do modelo dados dev 
sns.distplot(df_dev.prediction_score_1,
            label='Teste',
            ax = plt.gca())

#saída do modelo dados PROD 
...
## Produção ta muito diferente de teste? 
